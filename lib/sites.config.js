export const sites = {
  ...
  'employee-benefits': {
    ...
    repo: 'njaberalk/alkeme-employee-benefits',
    basePath: '/employee-benefits',
    branch: 'main',
    brand: 'ALKEME',
    vercelUrl: 'https://employee-benefits-nextjs.vercel.app',
    color: '#25475e',
    dataFiles: [
      'coverages', 'industries', 'resources', 'blog',
      'states-part1', 'states-part2', 'cities-part1', 'cities-part2',
  ...
  'business-insurance': {
    ...
    repo: 'njaberalk/alkeme-business-insurance',
    basePath: '/business-insurance',
    branch: 'main',
    brand: 'ALKEME',
    vercelUrl: 'https://business-insurance-nextjs.vercel.app',
    color: '#25475e',
    dataFiles: [
      'coverages', 'industries', 'resources', 'blog',
      'states-part1', 'states-part2', 'cities-part1', 'cities-part2',
